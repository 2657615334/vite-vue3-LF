  ...
  >
    <template #body>
      ...
      >
        ...
        <el-form-item :label="UserEntity.prototype.getCustomFieldName('userSex')" prop="userSex">
          <AInput v-model.userSex="data.userSex" :entity="UserEntity" />
        </el-form-item>
        <el-form-item :label="UserEntity.prototype.getCustomFieldName('remark')" prop="remark">
...
async function submitData() {
  ...
  new AirNotification().setTitle('修改用户成功')
