      ...
      >
        ...
        <div v-if="!hideFooter" class="footer">
          ...
          <div v-if="!hideCtrl" class="control">
            ...
            <el-button v-if="!hideCancel" class="cancel" @click="emits('onCancel')">{{ cancelText }}</el-button>
          </div>
        </div>
      </div>
    </div>
...
import { watch, ref, nextTick, PropType, computed } from 'vue'
...
const props = defineProps({
  ...
  hideCancel: {
    type: Boolean,
    default: AppConfig.defaultDialogHideCancel,
  },
  ...
  fullable: {
    type: Boolean,
    default: AppConfig.defaultDialogFullable,
  },
...
const init = () => {
  isFullScreen.value = props.fullable && props.fullScreen
}
