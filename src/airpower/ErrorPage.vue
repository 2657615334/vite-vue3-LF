<template>
  <div v-loading="isLoading" class="air-error-page big-loading">
    <div v-if="errorCode !== AirHttpStatus.OK" class="box">
      <div class="left">
    ...
    <div v-if="AppConfig.isTimeout" class="percent">
      <div />
    </div>
  </div>
</template>
